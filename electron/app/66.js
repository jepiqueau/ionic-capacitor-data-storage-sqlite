...
var Spinner = /** @class */ (function () {
    ...
    Spinner.prototype.render = function () {
        var _a;
        var self = this;
        var mode = Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["d"])(self);
...
var buildLine = function (spinner, duration, index, total) {
    var data = spinner.fn(duration, index, total);
    data.style['animation-duration'] = duration + 'ms';
    return (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])("line", { transform: "translate(32,32)", y1: data.y1, y2: data.y2 })));
};
